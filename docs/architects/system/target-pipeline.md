...
путь к каждому блоку — в [detailed-implementation-plan.md](../../base-plans/detailed-implementation-plan.md).

## Поток данных целиком

![Схема пайплайна: входные данные, база ассетов, идентификация и композиция, просчёт физики, рендер](assets/target-pipeline-schema.svg)
...
Рендерер (или мостовой 3D-построитель — [фаза 3](../../base-plans/detailed-implementation-plan.md#фаза-3--персистентное-3dнативное-состояние-мост-фото--видео),
...
подробнее в [фазе 4](../../base-plans/detailed-implementation-plan.md#фаза-4--латентный-физдвижок-динамика-видео)
и [фазе 5](../../base-plans/detailed-implementation-plan.md#фаза-5--интеграция-полный-нейродвижок-фото--видео).
...
- Значимые отклонения от этого описания фиксировать как [ADR](../adr/).
